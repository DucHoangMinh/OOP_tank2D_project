...
public class brick {
	...
	int solidBricksXPos[] = {350,600,350,600,200,350,600,850,200,350,600,850,200,350,500,550,600,850,200,
		350,850,0,50,750,800,850,600,200,600,750,100,150,200,600,100,350,400,
		450,600,750,100,350,600,650,700,750,900,950,100,350,100,150,200,350,400,450,200,
		650,700,750,800,850};
	int solidBricksYPos[] = {0,0,50,50,100,100,100,100,150,150,150,150,200,200,200,200,200,200,250,
		250,250,300,300,300,300,300,350,400,400,400,450,450,450,450,500,500,500,
		500,500,500,550,550,550,550,550,550,550,550,600,600,650,650,650,650,650,650,700,
		700,700,700,700,700};
	...
	int treebricksXpod[]={100,150,250,300,600,200,350,600,900,950,200,350,750,0,50,750,500,550,650,850,650,850};
    int treebricksYpod[]={100,100,100,100,250,300,300,300,300,300,350,350,350,450,450,450,500,500,600,600,650,650};
	//Mảng lưu item
	...
	int brickON[] = new int[22];
	int itemON[] = new int[8];
	

	//3 loại biến này để lưu hình ảnh của nước, gạch cứng, cây, item
	...
	//Khai báo địa chỉ hình ảnh của nước, gạch cứng, cây,item
	public brick()	
	{
